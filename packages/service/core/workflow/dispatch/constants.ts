...
export const FlowNodeTypeResTextMap: Record<FlowNodeTypeEnum, string> = {
  ...
  [FlowNodeTypeEnum.nestedStart]: 'loopInputValue',
  [FlowNodeTypeEnum.nestedEnd]: 'loopOutputValue',
  [FlowNodeTypeEnum.parallelRun]: 'parallelResult',
  [FlowNodeTypeEnum.loopRun]: 'loopRunHistory',
  [FlowNodeTypeEnum.loopRunStart]: 'loopInputValue',
